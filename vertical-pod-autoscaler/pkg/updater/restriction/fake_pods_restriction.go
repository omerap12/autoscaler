...
func (*FakePodsRestrictionFactory) GetCreatorMaps(pods []*corev1.Pod, vpa *vpa_types.VerticalPodAutoscaler, _ *vpaslices_types.VerticalPodAutoscalerSlice) (map[podReplicaCreator]singleGroupStats, map[string]podReplicaCreator, error) {
	return nil, nil, nil
}
