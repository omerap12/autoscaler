...
type AutoscalingV1alpha1Interface interface {
	...
	VerticalPodAutoscalerSlicesGetter
	VerticalPodAutoscalerSliceCheckpointsGetter
}
...
func (c *AutoscalingV1alpha1Client) VerticalPodAutoscalerSlices(namespace string) VerticalPodAutoscalerSliceInterface {
	return newVerticalPodAutoscalerSlices(c, namespace)
}

func (c *AutoscalingV1alpha1Client) VerticalPodAutoscalerSliceCheckpoints(namespace string) VerticalPodAutoscalerSliceCheckpointInterface {
	return newVerticalPodAutoscalerSliceCheckpoints(c, namespace)
}
